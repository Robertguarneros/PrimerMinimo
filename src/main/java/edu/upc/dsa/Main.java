...
public class Main {
    ...
    public static HttpServer startServer() {
        ...
        //no se debe cambiar en principio
        ...
        beanConfig.setDescription("REST API for Paratida Manager");
    ...
    public static void main(String[] args) throws IOException {
        ...
        StaticHttpHandler staticHttpHandler = new StaticHttpHandler("./public/");//monta el document root en carpeta publica
